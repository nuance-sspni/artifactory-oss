...
public abstract class BaseSearchResult extends BaseModel {
    ...
    public void setDownloadLink(String downloadLink) {
        if (!isDownloadBlockedByXray()) {
            this.downloadLink = downloadLink;
        }
    }

    private boolean isDownloadBlockedByXray() {
        return ContextHelper.get().beanForType(AddonsManager.class).addonByType(XrayAddon.class).isDownloadBlocked(repoPath);
    }
