...
public class GroupResource extends BaseResource {
    ...
    public Response createGroup(Group groupModel) throws Exception {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response updateGroup(Group groupModel) throws Exception {
    ...
    public Response getGroups() throws Exception {
        return runService(securityFactory.getAllGroups());
    }
