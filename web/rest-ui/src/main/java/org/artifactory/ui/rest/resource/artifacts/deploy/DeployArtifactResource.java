...
public class DeployArtifactResource extends BaseResource {
    ...
    public Response uploadArtifact(FormDataMultiPart formParams) throws Exception {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response cancelUploadArtifact(UploadArtifactInfo uploadArtifactInfo) throws Exception {
        return runService(deployFactory.cancelArtifactUpload(), uploadArtifactInfo);
    }

    @POST
    @Path("deploy")
    public Response deployArtifact(UploadArtifactInfo uploadArtifactInfo) throws Exception {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response uploadBundleArtifact(UploadArtifactInfo uploadArtifactInfo) throws Exception {
    ...
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    @Produces(MediaType.APPLICATION_JSON)
    public Response deployMultiArtifact(FormDataMultiPart formParams) throws Exception {
        UploadArtifactInfo uploadArtifactInfo = new UploadArtifactInfo(formParams);
