...
public class ArtifactActionsResource extends BaseResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public Response moveArtifact(MoveArtifact copyAction) throws Exception {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public Response ignoreAlert(BaseArtifact baseArtifact) throws Exception {
        return runService(browseFactory.setIgnoreAlert(), baseArtifact);
    }
}
