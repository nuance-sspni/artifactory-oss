...
public class PackageSearchService implements RestService {
    ...
    private Set<PackageSearchResult> executeSearch(/*AqlDomainEnum domain,*/ AqlBase query) {
        ...
        results = manipulateResultFields(results);
     ...
     */
    private Set<PackageSearchResult> reduceAggregatedResultRows(HashMultimap<RepoPath, AqlBaseFullRowImpl> resultsByPath) {
        Set<PackageSearchResult> concurrentSet = Collections.newSetFromMap(new ConcurrentHashMap<>());
     ...
     */
    private Set<PackageSearchResult> manipulateResultFields(Set<PackageSearchResult> results) {
