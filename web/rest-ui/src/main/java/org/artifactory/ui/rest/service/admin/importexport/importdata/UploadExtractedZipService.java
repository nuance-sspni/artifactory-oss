...
public class UploadExtractedZipService implements RestService {
    ...
    public static final String EXTRACTED_ZIP_SUFFIX = "_extract";
    ...
    public void execute(ArtifactoryRestRequest request, RestResponse response) {
        ...
        try {
            ...
            MultiPartUtils.saveUploadFileAsExtracted(new File(uploadDir, fileNames.get(0)), uuid + EXTRACTED_ZIP_SUFFIX,  response);
