...
import static org.artifactory.addon.xray.XrayAddon.*;
...
public class RepositoryFieldsValuesModel {
    ...
    private List<String> xraySeverities;
    ...
    public RepositoryFieldsValuesModel(CentralConfigDescriptor descriptor, RepositoryService repositoryService) {
        ...
        xraySeverities = Lists.newArrayList(ALERT_SEVERITY_MINOR, ALERT_SEVERITY_MAJOR, ALERT_SEVERITY_CRITICAL);
    }
    ...
    public List<String> getXraySeverities() {
        return xraySeverities;
    }
}
