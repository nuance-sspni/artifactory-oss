...
public class SumoLogicResource extends BaseResource {
    ...
    public Response callbackFromSumoLogicAuth(@PathParam("username") String username, @PathParam("setup") String setup,
        ...
        try {
            ...
            checkValue(username, StringUtils::isNotBlank, "username is required");
            checkValue(setup, SetupType::contains, "unexpected setup type: " + setup);
            checkValue(code, StringUtils::isNotBlank, "code is required");
            checkValue(baseUri, StringUtils::isNotBlank, "base_uri is required");
