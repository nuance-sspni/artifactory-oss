...
public class ChecksumSearchResource {
    ...
    private InfoRestSearchResult search(String md5Checksum, String sha1Checksum, String sha256,
            StringList reposToSearch) throws InvalidChecksumException {
        InfoRestSearchResult resultToReturn = new InfoRestSearchResult();
        Set<RepoPath> matchingArtifacts = restAddon
                .searchArtifactsByChecksum(md5Checksum, sha1Checksum, sha256, reposToSearch);
