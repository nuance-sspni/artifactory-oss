...
export class ArtifactoryDeployModal {
    ...
    createNotification(response) {
        ...
        let messageWithUrl = `Successfully deployed <a href="#/artifacts/browse/tree/General/${repoKey}/${artifactPath}">${this.jfrogUtils.getSafeHtml(artifactPath)}</a> to ${repoKey}`;
