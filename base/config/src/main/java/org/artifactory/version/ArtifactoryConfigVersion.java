...
public enum ArtifactoryConfigVersion implements SubConfigElementVersion {
    ...
    v180("http://artifactory.jfrog.org/xsd/1.8.0",
            ...
            ArtifactoryVersion.v4132, new ComposerDefaultLayoutConverter()),
    ...
    v203("http://artifactory.jfrog.org/xsd/2.0.3",
            ...
            ArtifactoryVersion.v532, new AccessTokenSettingsRenameToAccessClientSettingsConverter()),
    ...
    v205("http://artifactory.jfrog.org/xsd/2.0.5",
            ...
            ArtifactoryVersion.v540, //TODO [YA] Set correct versions!!
