...
public interface BuildService extends ImportableExportable {
     ...
     */
    void deleteBuild(BuildRun buildRun, boolean deleteArtifacts, BasicStatusHolder multiStatusHolder, boolean async);
     ...
     */
    @Async(workQueue = true, transactional = true)
   ...
   int  getPublishedModulesCounts(String buildName, String date);
    ...
    Set<BuildId> getLatestBuildIDsPaging(String offset, String orderBy, String direction, String limit);
