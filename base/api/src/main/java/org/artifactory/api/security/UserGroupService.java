...
public interface UserGroupService {
     ...
     */
    @Nonnull
    UserInfo findUser(String username, List<String> propertiesToRetrieve);
     ...
     * @param propertiesToRetrieve list of properties we want to retrieve about the user
     * @return UserInfo including groups and wanted properties if user with the input username exists
     */
    @Nullable
    UserInfo findUser(String username, boolean errorOnAbsence, List<String> propertiesToRetrieve);
    ...
    List<GroupInfo> getAllGroups(boolean includeAdmins);
    ...
    Map<Long, String> getAllUsernamePerIds();

    Map<String, Long> getAllGroupIdsToNames();

    /**
     * Map of group id to multiple users ids
     */
    Multimap<Long,Long> getAllUsersInGroups();
