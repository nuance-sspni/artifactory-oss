...
public abstract class JacksonFactory {
    ...
    /**
     * Creates a JsonGenerator using the given output stream as a writer. This method
     * allow choosing if the json will be pretty formatted or not
     *
     * @param outputStream     Stream to write to
     * @param usePrettyPrinter Use pretty printer format
     * @return Json Generator
     * @throws IOException
     */
    public static JsonGenerator createJsonGenerator(OutputStream outputStream, boolean usePrettyPrinter) throws IOException {
        ...
        updateGenerator(jsonFactory, jsonGenerator, usePrettyPrinter);
    ...
    public static JsonGenerator createJsonGenerator(Writer writer) throws IOException {
        ...
        updateGenerator(jsonFactory, jsonGenerator, true);
        return jsonGenerator;
    }
     ...
     */
    private static void updateGenerator(JsonFactory jsonFactory, JsonGenerator jsonGenerator, boolean usePrettyPrinter) {
