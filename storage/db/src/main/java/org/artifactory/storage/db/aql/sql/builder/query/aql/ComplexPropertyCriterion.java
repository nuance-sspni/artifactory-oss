            ...
            case notMatches: {
                ...
                if(isMspOperator()){
                    ...
                    return "(" + isNullSql(index1, fieldName) + " or not exists (select 1 from "
                            ...
                            " and " + fieldToSql(null, "prop_key") + " = " + paramToSql(variable1) +
                            " and " + fieldToSql(null, "prop_value") + " like  " +
                            paramToSql(variable2) + generateEscapingCriteria(param2) + "))";
                }
            }
            case less: {
                return "(" + generateEqualsQuery(key, variable1, params, index1) + " and " +
            ...
            case notEquals: {
                ...
                if(isMspOperator()){
                    ...
                    return "(" + isNullSql(index1, fieldName) + " or not exists (select 1 from " + tableName +
                            ...
                            fieldToSql(null, "prop_key") + " = " + paramToSql(variable1) + " and " +
                            fieldToSql(null, "prop_value") + " = " + paramToSql(variable2) + "))";
                }
            }
            default:
