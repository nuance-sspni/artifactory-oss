...
public class ItemStarElement extends LazyParserElement implements DomainProviderElement {
    ...
    private void fillWithSubDomains(List<ParserElement> list) {
        list.add(forward(new InternalNameElement(archives.signature), dot, archiveStar));
        list.add(forward(new InternalNameElement(artifacts.signature), dot, buildArtifactStar));
        list.add(forward(new InternalNameElement(dependencies.signature), dot, buildDependenciesStar));
        list.add(forward(new InternalNameElement(statistics.signature), dot, statisticsStar));
