 ...
 */
public class BuildModulePhysicalFieldsElement extends LazyParserElement implements DomainProviderElement {
    @Override
    ...
    private void fillWithDomainFields(List<ParserElement> list) {
        AqlPhysicalFieldEnum[] fields = modules.getPhysicalFields();
    ...
    private void fillWithSubDomains(List<ParserElement> list) {
        ...
        list.add(forward(new InternalNameElement(moduleProperties.signature), dot, buildModulePropertiesPhysicalFields));
    }
