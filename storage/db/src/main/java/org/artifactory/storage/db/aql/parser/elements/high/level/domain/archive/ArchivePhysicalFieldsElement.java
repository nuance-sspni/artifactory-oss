 ...
 */
public class ArchivePhysicalFieldsElement extends LazyParserElement implements DomainProviderElement {
    ...
    private void fillWithSubDomains(List<ParserElement> list) {
        ...
        list.add(forward(new InternalNameElement(entries.signature), dot, entriesPhysicalFields));
    }
