...
package org.artifactory.storage.db.aql.parser.elements.high.level.domain.build.property;
 ...
 */
public class BuildPropertyLogicalFieldsElement extends LazyParserElement implements DomainProviderElement {
    @Override
    ...
    private void fillWithDomainFields(List<ParserElement> list) {
        AqlLogicalFieldEnum[] fields = buildProperties.getLogicalFields();
        for (AqlLogicalFieldEnum field : fields) {
            list.add(new RealFieldElement(field.getSignature(), buildProperties));
        }
    }
