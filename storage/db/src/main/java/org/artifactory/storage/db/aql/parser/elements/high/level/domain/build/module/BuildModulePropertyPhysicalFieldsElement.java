...
import static org.artifactory.storage.db.aql.parser.AqlParser.buildModulePhysicalFields;
import static org.artifactory.storage.db.aql.parser.AqlParser.dot;

/**
 * @author Gidi Shabat
 */
public class BuildModulePropertyPhysicalFieldsElement extends LazyParserElement implements DomainProviderElement {
    @Override
    ...
    private void fillWithDomainFields(List<ParserElement> list) {
        AqlPhysicalFieldEnum[] fields = moduleProperties.getPhysicalFields();
