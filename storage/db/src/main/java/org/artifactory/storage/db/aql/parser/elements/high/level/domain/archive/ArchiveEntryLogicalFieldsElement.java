...
import static org.artifactory.storage.db.aql.parser.AqlParser.archiveLogicalFields;
import static org.artifactory.storage.db.aql.parser.AqlParser.dot;

/**
 * @author Gidi Shabat
 */
public class ArchiveEntryLogicalFieldsElement extends LazyParserElement implements DomainProviderElement {
    ...
    private void fillWithDomainFields(List<ParserElement> list) {
        AqlLogicalFieldEnum[] fields = entries.getLogicalFields();
