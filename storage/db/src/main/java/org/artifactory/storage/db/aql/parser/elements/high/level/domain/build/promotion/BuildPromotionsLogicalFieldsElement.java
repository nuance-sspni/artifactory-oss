 ...
 * @author gidis
 */
public class BuildPromotionsLogicalFieldsElement extends LazyParserElement implements DomainProviderElement {
    @Override
    ...
    private void fillWithDomainFields(List<ParserElement> list) {
        AqlLogicalFieldEnum[] fields = buildPromotions.getLogicalFields();
