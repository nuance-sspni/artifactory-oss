 ...
 */
public class BuildArtifactPhysicalFieldsElement extends LazyParserElement implements DomainProviderElement {
    @Override
    ...
    private void fillWithDomainFields(List<ParserElement> list) {
        AqlPhysicalFieldEnum[] fields = artifacts.getPhysicalFields();
        for (AqlPhysicalFieldEnum field1 : fields) {
            list.add(new RealFieldElement(field1.getSignature(), artifacts));
        }
    }
