 ...
 * @author Gidi Shabat
 */
public class DynamicPhysicalFieldTail extends DomainSensitiveParserElement {

    @Override
    protected ParserElement init() {
        return fork(empty, forward(comma, quotes, provide(DynamicPhysicalField.class), quotes, provide(DynamicPhysicalFieldTail.class)));
    }
}
