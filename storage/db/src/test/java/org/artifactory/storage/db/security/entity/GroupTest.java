...
public class GroupTest {
    ...
    public void simpleGroupTest() {
        Group g = new Group(1L, "g1", null, false, null, null, false);
    ...
    public void noGroupIdTest() {
        new Group(0L, "XXX", "group description", true, "ldap", "dn=o", false);
    }

    @Test(expectedExceptions = {IllegalArgumentException.class})
    public void noGroupNameTest() {
        new Group(1L, "", "group description", true, "ldap", "dn=o", false);
    }

    public void withRealmGroupTest() {
        Group g = new Group(1L, "g1", "group description", true, "ldap", "dn=o", false);
        assertEquals(g.getGroupId(), 1L);
        assertEquals(g.getGroupName(), "g1");
