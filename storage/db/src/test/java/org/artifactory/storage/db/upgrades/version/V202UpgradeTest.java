...
/**
 * Test DB version v201 (art version v531)
 ...
 */
@Test
public class V202UpgradeTest extends ArtifactoryDBVersionTest {
    ...
    public void testConversionFromV441ToV530() throws IOException, SQLException {
        ...
        try (Connection connection = jdbcHelper.getDataSource().getConnection()) {
            ...
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v311", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v410", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v420", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v440", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v500", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v500a", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v530", dbProperties.getDbType()));
    ...
    public void testConversionFromV4142ToV530() throws IOException, SQLException {
        ...
        try (Connection connection = jdbcHelper.getDataSource().getConnection()) {
            ...
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v420", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v440", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v441", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v500", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v500a", dbProperties.getDbType()));
            CommonDbUtils.executeSqlStream(connection, getDbSchemaUpgradeSql("v530", dbProperties.getDbType()));
