...
/**
 * Tests coverage of Artifactory db versions
 *
 * @author Dan Feldman
 */
public class ArtifactoryDbVersionTest extends VersionTest {

    @Override
    protected SubConfigElementVersion[] getVersions() {
        return ArtifactoryDBVersion.values();
    }

    @Override
    protected ArtifactoryVersion getFirstSupportedArtifactoryVersion() {
        return ArtifactoryVersion.v300;
    }
}
