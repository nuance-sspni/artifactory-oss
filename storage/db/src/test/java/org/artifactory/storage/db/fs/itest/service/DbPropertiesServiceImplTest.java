...
//        setLoggingLevel(DbPropertiesServiceImpl.class, Level.TRACE);
    }
    ...
    public void testUpdateProperties() throws Exception {
        ...
        propertiesService.setProperties(nodeId, properties);
    ...
    public void testSetPropertiesWithChangeTrackingUsedOnlyForTheOwningNode() throws Exception {
        ...
        propertiesService.setProperties(nodeId1, properties1);
        properties2.put("key1", "value1a");
        propertiesService.setProperties(nodeId2, properties2);
        ...
        propertiesService.setProperties(nodeId1, properties1);
        propertiesService.setProperties(nodeId2, properties1);
    ...
    private Map<String, Set<Long>> getPropKey2PropIdsMap(int nodeId) throws SQLException {
        ...
        propsDao.getNodeProperties(nodeId).stream().forEach(prop -> {
            Set<Long> ids = key2propId.get(prop.getPropKey());
            if (ids == null) {
                ids = Sets.newHashSet();
                key2propId.put(prop.getPropKey(), ids);
            }
