...
public class SumoLogicServiceImplTest {
    ...
    private void setDescriptor(CentralConfigService configService, MutableCentralConfigDescriptor config) {
        ...
        VersioningCache<CentralConfigServiceImpl.CentralConfigDescriptorCache> versioningCache =
                new VersioningCache<>(3000, () -> cache);
        ReflectionTestUtils.setField(configService, "descriptorCache",versioningCache);
    }
