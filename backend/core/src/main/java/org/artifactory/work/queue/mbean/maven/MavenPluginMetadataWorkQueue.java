 ...
 * @author gidis
 */
public class MavenPluginMetadataWorkQueue implements MavenPluginMetadataWorkQueueMBean {
    private WorkQueueMBean workQueueMBean;

    public MavenPluginMetadataWorkQueue(WorkQueueMBean workQueueMBean) {
