...
public class CompoundInvocation implements MethodInvocation {
    ...
    private List<TraceableMethodInvocation> invocations = new ArrayList<>();
    ...
    void add(TraceableMethodInvocation invocation) {
        invocations.add(invocation);
    }

    @Override
    public Object proceed() throws Throwable {
        List<TraceableMethodInvocation> tmpInvocations = ImmutableList.copyOf(invocations);
        invocations.clear();
        for (TraceableMethodInvocation invocation : tmpInvocations) {
