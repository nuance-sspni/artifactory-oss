...
public class SingleArtifactMoveCopier {
     ...
     */
    public void executeOperation(MoveCopyItemInfo itemInfo, MoveMultiStatusHolder status, MoveCopyContext context) {
    ...
    protected MutableVfsFile copyFile(VfsFile sourceItem, VfsItem targetItem, RepoRepoPath<LocalRepo> targetRrp, MoveCopyContext context) {
        ...
        targetFile.tryUsingExistingBinary(sourceItem.getSha1(), sourceItem.getMd5(), sourceItem.length());
    ...
    protected void overrideTargetFileIfExist(RepoRepoPath<LocalRepo> targetRrp, VfsItem targetItem, LocalRepo targetRepo, MoveMultiStatusHolder status) {
