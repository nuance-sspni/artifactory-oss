...
public class MoveCopyHelper {
    ...
    public static MoveMultiStatusHolder doExecuteMoveCopyOnBulk(List<MoveCopyItemInfo> items,
                                                                MoveCopyContext context, SingleArtifactMoveCopier copier,
                                                                List<MoveCopyListeners> moveCopyListeners,
                                                                List<MoveCopyValidator> validators) {
        ...
        for (MoveCopyItemInfo element : items) {
            ...
            // Do move copy
            copier.executeOperation(element, status, context);
