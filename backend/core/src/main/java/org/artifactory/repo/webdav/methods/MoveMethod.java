...
public class MoveMethod implements WebdavMethod {
    ...
    public void handle(ArtifactoryRequest request, ArtifactoryResponse response) throws IOException {
        ...
        RepoPath targetPath = InternalRepoPathFactory.create(targetPathWithoutContextUrl);
        ...
        MoveMultiStatusHolder status = getMoveMultiStatusHolder(repoPath, targetPath, request);
