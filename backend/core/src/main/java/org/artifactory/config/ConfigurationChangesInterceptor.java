...
public interface ConfigurationChangesInterceptor extends Interceptor {
    ...
    /**
     * Called after the context has been reloaded with {@param newDescriptor} if this node initiated a save of it.
     */
    void onAfterSave(CentralConfigDescriptor newDescriptor, CentralConfigDescriptor oldDescriptor);
}
